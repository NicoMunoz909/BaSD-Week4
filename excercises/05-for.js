...
var array = ['lorem', 'ipsum', 'dolor', 'sit', 'amet'];
for (var i = 0; i < array.length; i++) {
    alert(array[i]);
}
console.log(`Excercise 5.a`);
console.log(`Shown on alerts`);
...
desde el número 0 hasta al número 9. Mostrar por la consola del navegador el 
