...
console.log(`string:${string1} uppercased string:${uppercaseString1}`)
...
console.log(`string:${string2} first five characters:${substring2}`)
...
console.log(`string:${string3} last three characters:${substring3}`)
...
console.log(`string:${string4} capitalized string:${newString}`)
...
console.log(`string:${string5} white space index:${whitSpaceIndex}`)
...
console.log(`string:${string6} transformed string:${myNewString}`)